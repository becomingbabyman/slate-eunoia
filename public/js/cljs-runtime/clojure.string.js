...
G__27322.cljs$lang$applyTo = (function (arglist__27328){
...
while(true){
if(!((coll__$1 == null))){
var G__27344 = sb.append([cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(coll__$1))].join(''));
var G__27345 = cljs.core.next(coll__$1);
sb = G__27344;
coll__$1 = G__27345;
continue;
} else {
...
var G__27349 = cljs.core.pop(v__$1);
v__$1 = G__27349;
continue;
} else {
return v__$1;
