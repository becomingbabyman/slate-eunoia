...
if((i < len)){
var k = (ks[i]);
var G__34790 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__34791 = (i + (1));
m = G__34790;
i = G__34791;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__34803 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__34803);
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__34817 = c;
var G__34817__$1 = (((G__34817 == null))?null:G__34817.prototype);
if((G__34817__$1 == null)){
return null;
} else {
return (G__34817__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__34827 = c;
var G__34827__$1 = (((G__34827 == null))?null:G__34827.prototype);
if((G__34827__$1 == null)){
return null;
} else {
return (G__34827__$1["render"]);
}
})() == null))));
});
...
var G__34855 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__34855) : reagent.impl.component.as_element.call(null,G__34855));
};
...
while (G__34865__i < G__34865__a.length) {G__34865__a[G__34865__i] = arguments[G__34865__i + 0]; ++G__34865__i;}
  args = new cljs.core.IndexedSeq(G__34865__a,0,null);
} 
return G__34861__delegate.call(this,args);};
G__34861.cljs$lang$maxFixedArity = 0;
G__34861.cljs$lang$applyTo = (function (arglist__34866){
...
var _STAR_current_component_STAR_34868 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_34868;
}});
...
return ((function (G__34872,G__34872__$1){
...
var c = this;
var G__34882_34894 = (c["cljsRatom"]);
if((G__34882_34894 == null)){
} else {
reagent.ratom.dispose_BANG_(G__34882_34894);
}
...
var renders_34914 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_34915 = cljs.core.first(cljs.core.vals(renders_34914));
if((cljs.core.count(renders_34914) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_34914))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_34915)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_34915], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__34913 = name;
switch (G__34913) {
case "":
...
var G__34920 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__34920);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__34921 = fiber;
var G__34921__$1 = (((G__34921 == null))?null:(G__34921["type"]));
if((G__34921__$1 == null)){
return null;
} else {
return (G__34921__$1["displayName"]);
}
})();
var parent = (function (){var G__34922 = fiber;
if((G__34922 == null)){
return null;
} else {
return (G__34922["return"]);
}
})();
var path = (function (){var G__34924 = parent;
var G__34924__$1 = (((G__34924 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__34924) : reagent.impl.component.fiber_component_path.call(null,G__34924)));
if((G__34924__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34924__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__34929 = c;
if((G__34929 == null)){
return null;
} else {
return (G__34929["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__34930._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__34932 = c;
if((G__34932 == null)){
return null;
} else {
return (G__34932["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__34934 = c;
if((G__34934 == null)){
return null;
} else {
return G__34934._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__34936 = instance;
if((G__34936 == null)){
return null;
} else {
return (G__34936["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__34937 = instance;
if((G__34937 == null)){
return null;
} else {
return G__34937._currentElement;
}
}
})();
var name = (function (){var G__34938 = elem;
var G__34938__$1 = (((G__34938 == null))?null:(G__34938["type"]));
if((G__34938__$1 == null)){
return null;
} else {
return (G__34938__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__34940 = elem;
if((G__34940 == null)){
return null;
} else {
return (G__34940["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__34941._owner;
}
}
})();
var path = (function (){var G__34942 = owner;
var G__34942__$1 = (((G__34942 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__34942) : reagent.impl.component.component_path.call(null,G__34942)));
if((G__34942__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34942__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__34946 = c;
var G__34946__$1 = (((G__34946 == null))?null:G__34946.constructor);
if((G__34946__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__34946__$1);
}
}
})();
