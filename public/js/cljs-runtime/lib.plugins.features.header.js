...
var matches = cljs.core.re_matches(/header(1|2|3)/,props.node.type);
if(cljs.core.truth_(matches)){
return reagent.core.create_element.cljs$core$IFn$_invoke$arity$3(["h",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.last(matches))].join(''),props.attributes,props.children);
} else {
return null;
}
});
