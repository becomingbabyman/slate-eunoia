...
var G__34965 = o;
(G__34965[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__34966__delegate = function (args){
...
var G__34969 = o;
(G__34969[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__34978__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__34983__i < G__34983__a.length) {G__34983__a[G__34983__i] = arguments[G__34983__i + 0]; ++G__34983__i;}
  args = new cljs.core.IndexedSeq(G__34983__a,0,null);
} 
return G__34978__delegate.call(this,args);};
G__34978.cljs$lang$maxFixedArity = 0;
G__34978.cljs$lang$applyTo = (function (arglist__34984){
var args = cljs.core.seq(arglist__34984);
return G__34978__delegate(args);
});
...
var G__34986 = props;
var G__34986__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34986,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34986);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34986__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__34987){
...
var props = map__34988__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34988__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__34988,map__34988__$1,props,class$){
return (function (c){
...
});})(map__34988,map__34988__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__35019){
var map__35024 = p__35019;
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35024__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__35024,map__35024__$1,on_write){
return (function (){
...
});})(node_value,map__35024,map__35024__$1,on_write))
);
} else {
...
var G__35035 = jsprops;
(G__35035["defaultValue"] = value);

(G__35035["onChange"] = ((function (G__35035,v,value,on_change){
return (function (p1__35033_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__35033_SHARP_);
});})(G__35035,v,value,on_change))
);
...
var vec__35041 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35041,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35041,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35041,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___35065 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___35065 == null)){
} else {
var key_35066 = temp__5461__auto___35065;
(jsprops["key"] = key_35066);
}
...
var temp__5461__auto___35076 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___35076 == null)){
} else {
var key_35081 = temp__5461__auto___35076;
reagent.impl.template.oset(jsprops,"key",key_35081);
}
...
var G__35092 = reagent.impl.template.__GT_NativeWrapper();
(G__35092["name"] = c);
...
var G__35101 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__35101) : reagent.impl.template.as_element.call(null,G__35101));
} else {
...
var len__4531__auto___35109 = arguments.length;
var i__4532__auto___35110 = (0);
while(true){
if((i__4532__auto___35110 < len__4531__auto___35109)){
args__4534__auto__.push((arguments[i__4532__auto___35110]));

var G__35111 = (i__4532__auto___35110 + (1));
i__4532__auto___35110 = G__35111;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35105){
var G__35106 = cljs.core.first(seq35105);
var seq35105__$1 = cljs.core.next(seq35105);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35106,seq35105__$1);
});
...
break;
default:
var G__35142 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__35142;
continue;
...
var n__4408__auto___35155 = a.length;
var i_35156 = (0);
while(true){
if((i_35156 < n__4408__auto___35155)){
(a[i_35156] = reagent.impl.template.as_element((a[i_35156])));

var G__35157 = (i_35156 + (1));
i_35156 = G__35157;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___35165 = a.length;
var i_35166 = (0);
while(true){
if((i_35166 < n__4408__auto___35165)){
var val_35167 = (a[i_35166]);
if(((cljs.core.vector_QMARK_(val_35167)) && ((reagent.impl.template.key_from_vec(val_35167) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_35166] = reagent.impl.template.as_element(val_35167));

var G__35168 = (i_35166 + (1));
i_35166 = G__35168;
continue;
} else {
}
...
var ctx = ({});
var vec__35170 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35170,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35170,(1),null);
...
var G__35173 = (cljs.core.count(argv) - first_child);
switch (G__35173) {
case (0):
...
case (1):
var G__35174 = comp;
var G__35175 = jsprops;
var G__35176 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__35174,G__35175,G__35176);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__35173){
