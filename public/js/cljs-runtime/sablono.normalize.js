...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__28513){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__28517_SHARP_){
return (((p1__28517_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__28517_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__28518,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__28518;
}
});
...
var len__4531__auto___28521 = arguments.length;
var i__4532__auto___28522 = (0);
while(true){
if((i__4532__auto___28522 < len__4531__auto___28521)){
args__4534__auto__.push((arguments[i__4532__auto___28522]));

var G__28523 = (i__4532__auto___28522 + (1));
i__4532__auto___28522 = G__28523;
continue;
} else {
}
break;
...
var G__28520 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_(classes))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28520,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__28520;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq28519){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28519));
});
...
var vec__28526 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__28530 = cljs.core.ffirst(matches);
var fexpr__28529 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__28529.cljs$core$IFn$_invoke$arity$1 ? fexpr__28529.cljs$core$IFn$_invoke$arity$1(G__28530) : fexpr__28529.call(null,G__28530));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28526,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28526,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some(((function (matches,vec__28526,tag_name,names){
return (function (p1__28524_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__28524_SHARP_))){
return p1__28524_SHARP_;
} else {
return null;
}
});})(matches,vec__28526,tag_name,names))
,names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1(((function (matches,vec__28526,tag_name,names){
return (function (p1__28525_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__28525_SHARP_));
});})(matches,vec__28526,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__28532){
...
var tag = first__28535;
var content = seq__28534__$1;
...
var vec__28536 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28536,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28536,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28536,(2),null);
